...
1. Создаем метод для создания массива с заданным числом элементов
2. Создаем метод для печати массива
3. Создаем метод для подсчета четных элементов массива, для того, чтобы использовать его при создании нового массива.
4. Создаем метод который записывает четный элемент первого массива в новый массив.
5. Выводим на печать оба массива

![Images 1](blok_schema.jpg)